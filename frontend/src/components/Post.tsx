            ...
            <div className="mt-4">
              ...
              <div className="mt-4">
                ...
                {!loadingComments && !commentsError && (
                  <FlatComments parentId={post._id} formatDate={formatDate} allComments={comments} replyingCommentId={replyingCommentId} setReplyingCommentId={setReplyingCommentId} />
                )}
...
function FlatComments({ parentId, formatDate, allComments, replyingCommentId, setReplyingCommentId }: { parentId: string | null, formatDate: (date: string) => string, allComments: any[], replyingCommentId: string | null, setReplyingCommentId: (id: string | null) => void }) {
